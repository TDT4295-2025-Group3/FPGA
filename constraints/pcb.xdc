...
set_property -dict { PACKAGE_PIN C15 IOSTANDARD LVCMOS33 } [get_ports { vga_r[4] }]
...
set_property -dict { PACKAGE_PIN V11 IOSTANDARD LVCMOS33 } [get_ports { vga_g[4] }]
set_property -dict { PACKAGE_PIN V11 IOSTANDARD LVCMOS33 } [get_ports { vga_g[5] }]
...
set_property -dict { PACKAGE_PIN J15 IOSTANDARD LVCMOS33 } [get_ports { vga_b[4] }]
