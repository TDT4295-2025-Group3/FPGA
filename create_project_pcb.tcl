...
set top_name "top_pcb"
set part_name "xc7a100tftg256-1"
...
# ---------------------------------------------------
# Constraints
if {[file exists ../constraints/pcb.xdc]} {
    puts "Adding constraints: ../constraints/pcb.xdc"
    add_files ../constraints/pcb.xdc
} else {
